    ...
    return (
       ...
       <div className='contact-container'>
            <section className="mb-4 contact-section">
                ...
                <p className="text-center w-responsive mx-auto mb-5 p-3">
                ...
                <div className="row">
                    ...
                    <div className="col-md-9 mb-md-0 mb-5 contact-form">
                        ...
                        <div className="text-center text-md-left">
                            <a className="btn btn-primary mt-5" href="/contact" onClick="document.getElementById('contact-form').submit();">Send</a>
                        </div>
                    ...
                    <div className="col-md-3 text-center address-line">
                        <ul className="list-unstyled mb-0">
                            <li><i className="fas fa-map-marker-alt fa-2x"></i>
                                <p>Colombo, Western Province, LK</p>
                            </li>
                            ...
                            <li><i className="fas fa-envelope mt-4 fa-2x"></i>
                                <p>chandrasekaranrathushan@gmail.com</p>
                            </li>
                        </ul>
                    </div>
